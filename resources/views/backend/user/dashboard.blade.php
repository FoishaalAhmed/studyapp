                            ...
                            <div class="card-body">
                                ...
                                <div class="product-info">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <h5 class="font-16 mt-0 sp-line-1"><a href="{{ route('user.mcq.categories', [$item->id, strtolower(str_replace([' ', '_', '&'], '-', $item->name))]) }}" class="text-dark">{{ $item->name }}</a> </h5>
                                        </div>
                                    </div> <!-- end row -->
                            ...
                            <div class="card product-box">
                                <div class="card-body">
                                    ...
                                    <div class="product-info">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                <h5 class="font-16 mt-0 sp-line-1"><a href="{{ route('user.ebooks.categories', [$item->id, strtolower(str_replace([' ', '_', '&'], '-', $item->name))]) }}" class="text-dark">{{ $item->name }}</a> </h5>
                                            </div>
                                        </div> <!-- end row -->
                                    </div> <!-- end product info-->
                                </div>
