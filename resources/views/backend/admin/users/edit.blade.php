        ...
        <div class="row mt-4">
            <div class="col-12">
                <div class="card">
                    @include('alert')
                    <div class="card-body">
                        <h4 class="header-title">{{ __('Update User') }}</h4>
                        ...
                        <form action="{{ route('admin.users.update', $user->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" placeholder="{{ __('Full Name') }}" required="" value="{{ old('name', $user->name) }}">
                                    @error('name')
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <input type="text" name="email" id="email" class="form-control" placeholder="{{ __('Email Address') }}" required="" value="{{ old('email', $user->email) }}">
                                    @error('email')
                                        <div class="invalid-feedback error">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <input type="text" name="phone" id="phone" class="form-control" placeholder="{{ __('Phone') }}" required="" value="{{ old('phone', $user->phone) }}">
                                    @error('phone')
                                        <div class="invalid-feedback error">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <input type="text" name="age" id="age" class="form-control" placeholder="{{ __('Age') }}" required="" value="{{ old('age', $user->age) }}">
                                    @error('age')
                                        <div class="invalid-feedback error">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <select class="form-control select2-multiple" name="category[]" data-toggle="select2" data-width="100%" multiple="multiple" data-placeholder="{{ __('Choose Prefered Categories') }}">
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}" {{ in_array($category->id, $categoryArray) ? 'selected' : '' }}>{{ $category->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('category')
                                        <div class="invalid-feedback error">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <textarea class="form-control" name="present_address" placeholder="{{ __('Present Address') }}"
                                        id="present_address">{{ old('present_address', $user->present_address) }}</textarea>
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <textarea class="form-control" name="permanent_address" placeholder="{{ __('Permanent Address') }}"
                                        id="permanent_address">{{ old('permanent_address', $user->permanent_address) }}</textarea>
