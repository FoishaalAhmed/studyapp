        ...
        <div class="row mt-4">
            <div class="col-12">
                <div class="card">
                    @include('alert')
                    <div class="card-body">
                        <h4 class="header-title">{{ __('New App User Child Category') }}</h4>
                        ...
                        <form action="{{ route('admin.app-user-child-categories.store') }}" method="post">
                            @csrf
                            <div class="row">
...
@section('js')
    ...
    <script src="{{ asset('public/assets/backend/js/custom/app-user-child-category-create.js') }}"></script>
