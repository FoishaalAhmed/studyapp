                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-muted font-13 mb-4 text-end mt-n4">
                            <a href="{{ route('admin.writers.create') }}" class="btn btn-outline-primary waves-effect waves-light"><i class="fe-plus-square"></i> {{ __('New Writer') }}</a>
                        </p>
