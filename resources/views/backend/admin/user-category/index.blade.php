                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-muted font-13 mb-4 text-end mt-n4">
                            <a href="{{ route('admin.app-user-categories.create') }}" class="btn btn-outline-primary waves-effect waves-light"><i class="fe-plus-square"></i> {{ __('New Data') }}</a>
                        </p>
                                ...
                                <tbody>
                                    @foreach ($result as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.app-user-categories.edit', $item['id']) }}" class="btn btn-outline-success waves-effect waves-light"><i class="fe-edit"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
