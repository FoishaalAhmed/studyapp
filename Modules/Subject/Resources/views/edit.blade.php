...
@section('title', __('Update Subject'))
        ...
        <div class="row mt-4">
            <div class="col-12">
                <div class="card">
                    @include('alert')
                    <div class="card-body">
                        <h4 class="header-title">{{ __('Update Subject') }}</h4>
                        ...
                        <form action="{{ route('admin.subjects.update', $subject->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-8 col-xl-7">
                                    <input type="text" name="name" id="name" class="form-control" placeholder="{{ __('Name') }}" required="" value="{{ old('name', $subject->name) }}">
                                    @error('name')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-8 col-xl-7">
                                    ...
                                    <img src="{{ asset($subject->photo) }}" alt="{{ __('Photo') }}" class="large-logo" id="subject-photo">
