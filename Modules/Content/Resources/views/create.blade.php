        ...
        <div class="row mt-4">
            <div class="col-12">
                <div class="card">
                    @include('alert')
                    <div class="card-body">
                        <h4 class="header-title">{{ __('New Content') }}</h4>
                        ...
                        <form action="{{ route('admin.contents.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-8 col-xl-7">
                                    <input type="text" name="category" id="category" class="form-control" placeholder="{{ __('Category') }}" required="" value="{{ old('category') }}">
                                    @error('category')
                                        <div class="invalid-feedback error">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-8 col-xl-7">
                                    <textarea class="form-control" id="editor" name="text" placeholder="{{ __('Text') }}">{{ old('text') }}</textarea>
                                    @error('text')
                                        <div class="invalid-feedback error">
                                            {{ $message }}
                                        </div>
