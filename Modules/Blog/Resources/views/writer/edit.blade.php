        ...
        <div class="row mt-4">
            <div class="col-12">
                <div class="card">
                    @include('alert')
                    <div class="card-body">
                        <h4 class="header-title">{{ __('Update Blog') }}</h4>
                        ...
                        <form action="{{ route('writer.blogs.update', $blog->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-lg-9">
                                    <div class="row mb-3">
                                        <div class="col-lg-6 mb-3">
                                            ...
                                            <input type="text" name="date" id="date" class="form-control" placeholder="{{ __('Date') }}" required="" value="{{ old('date', $blog->date) }}" data-provide="datepicker">
                                            @error('date')
                                        ...
                                        <div class="col-lg-6 mb-3">
                                            ...
                                            <input type="text" name="title" id="title" class="form-control" placeholder="{{ __('Title') }}" required="" value="{{ old('title', $blog->title) }}">
                                            @error('title')
                                                <div class="invalid-feedback error">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-lg-12 mb-3">
                                            ...
                                            <input type="text" name="tag" id="tag" class="form-control" required="" value="{{ old('tag', $blog->tag) }}">
                                            @error('tag')
                                                <div class="invalid-feedback error">
                                                    {{ $message }}
                                                </div>
                                ...
                                <div class="col-lg-3">
                                    <div class="card card-border">
                                        <img class="card-img-top img-fluid" id="blog-photo" src="{{ file_exists($blog->photo) ? asset($blog->photo) : asset('public/images/dummy/blog.jpg') }}" alt="{{ __('Blog Image') }}">
                                        <div class="card-body">
