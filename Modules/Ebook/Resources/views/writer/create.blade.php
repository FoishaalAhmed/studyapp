                        ...
                        <form action="{{ route('writer.ebooks.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <input type="text" name="title" id="title" class="form-control" placeholder="{{ __('Title') }}" required="" value="{{ old('title', old('title')) }}">
                                    @error('title')
                                        <div class="invalid-feedback error">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <select class="form-control" name="type" id="type" data-toggle="select2" data-width="100%" required="">
                                        <option value="Free" {{ 'Free' == old('type') || old('type') ? 'selected' : '' }}>{{ __('Free') }}</option>
                                        <option value="Premium" {{ 'Premium' == old('type') || old('type') ? 'selected' : '' }}>{{ __('Premium') }}</option>
                                    </select>
                                    @error('type')
                                        <div class="invalid-feedback error">
                                            {{ $message }}
                                ...
                                <div class="col-lg-4 mb-3" id="price-div" style="display:{{ old('type') == 'Premium' ? '' : 'none' }}">
                                    ...
                                    <input type="text" name="price" id="price" class="form-control" placeholder="{{ __('Price') }}" value="{{ old('price', old('price')) }}">
                                    @error('price')
                                        <div class="invalid-feedback error">
                                            {{ $message }}
                                        </div>
