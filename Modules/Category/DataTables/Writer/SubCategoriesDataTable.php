    ...
    public function ajax(): JsonResponse
    {
        return datatables()
            ...
            ->addColumn('name', function ($subCategory) {
                return '<a href="'. route('writer.child-categories.index', ['category_id' => $subCategory->id]) .'">'. $subCategory->name .'</a>';
            })
            ...
            ->addColumn('action', function ($subCategory) {
                ...
                $edit = auth()->id() == $subCategory->user_id ? '<a href="' . route('writer.sub-categories.edit', $subCategory->id) . '" class="btn btn-outline-success waves-effect waves-light"><i class="fe-edit"></i></a>&nbsp;' : '&nbsp;';
                return $edit;
            })
