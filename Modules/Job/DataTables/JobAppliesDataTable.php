    ...
    public function ajax(): JsonResponse
    {
        return datatables()
            ...
            ->addColumn('action', function ($apply) {
                return '<a href="' . route('admin.jobs.users.show', ['jobId' => $apply->job_id, 'userId' => $apply->user_id]) . '" class="btn btn-outline-primary waves-effect waves-light"><i class="fe-eye"></i></a>';
            })
