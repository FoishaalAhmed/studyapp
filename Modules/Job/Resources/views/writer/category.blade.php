...
@section('title', __('All Job Category'))
@section('css')
    <!-- third party css -->
    ...
    <div class="container-fluid">
        <div class="row mt-4">
            <div class="col-12">
                <div class="card">
                    @include('alert')
                    <div class="card-body">
                        <h4 class="header-title">{{ __('All Job Category') }}</h4>
                        <p class="text-muted font-13 mb-4 text-end mt-n4">
                            <a href="javascript:;" class="btn btn-outline-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#add-modal"><i class="fe-plus-square"></i> {{ __('New Job Category') }}</a>
                        </p>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myLargeModalLabel">{{ __('New Job Category') }}</h4>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form action="{{ route('writer.job-categories.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
        ...
        <div class="modal fade" id="edit-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myLargeModalLabel">{{ __('Update Job Category') }}</h4>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
...
@section('js')
    ...
    <script>
        'use strict';
        let updateUrl = "{{ URL::to('writer/job-categories/update') }}";
        let basUrl = "{!! url('/') !!}";
    </script>

    <script src="{{ asset('Modules/Job/Resources/assets/js/category.js') }}"></script>
