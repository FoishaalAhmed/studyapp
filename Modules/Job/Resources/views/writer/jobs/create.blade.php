        ...
        <div class="row mt-4">
            <div class="col-12">
                <div class="card">
                    @include('alert')
                    <div class="card-body">
                        <h4 class="header-title">{{ __('New Job') }}</h4>
                        ...
                        <form action="{{ route('writer.jobs.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-9">
                                    <div class="row mb-3">
                                        <div class="col-lg-6 mb-3">
                                            ...
                                            <select class="form-control" name="job_category_id" id="job_category_id" data-toggle="select2" data-width="100%" required="">
                                                @foreach ($categories as $category)
                                                    <option value="{{ $category->id }}" {{ $category->id == old('job_category_id') ? 'selected' : '' }}>{{ $category->name }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-lg-6 mb-3">
                                            ...
                                            <input type="text" name="company" id="company" class="form-control" placeholder="{{ __('Company') }}" required="" value="{{ old('company') }}">
                                            @error('company')
                                                <div class="invalid-feedback error">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-lg-6 mb-3">
                                            ...
                                            <input type="text" name="salary" id="salary" class="form-control" placeholder="{{ __('Salary') }}" required="" value="{{ old('salary') }}">
                                            @error('salary')
                                                <div class="invalid-feedback error">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-lg-6 mb-3">
                                            ...
                                            <input type="text" name="location" id="location" class="form-control" placeholder="{{ __('Location') }}" required="" value="{{ old('location') }}">
                                            @error('location')
                                                <div class="invalid-feedback error">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-lg-6 mb-3">
                                            ...
                                            <input type="text" name="end_date" id="end_date" class="form-control" placeholder="{{ __('End Date') }}" data-provide="datepicker" value="{{ old('end_date') }}" required="">
                                            @error('end_date')
                                                <div class="invalid-feedback error">
                                                    {{ $message }}
                                                </div>
                                ...
                                <div class="col-lg-3">
                                    <div class="card card-border">
                                        <img class="card-img-top img-fluid" id="job-photo" src="{{ asset('public/images/dummy/job.jpg') }}" alt="{{ __('Job Image') }}">
                                        <div class="card-body">
