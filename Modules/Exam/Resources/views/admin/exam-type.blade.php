...
@section('title', __('All Exam Type'))
@section('css')
    <!-- third party css -->
...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!--  Modal content for the exam Type add -->
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myLargeModalLabel">{{ __('New Exam Type') }}</h4>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form action="{{ route('admin.exam-types.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
...
@section('js')
    ...
    <script>
        'use strict';
        let updateUrl = "{{ URL::to('admin/exam-types/update') }}";
        let basUrl = "{!! url('/') !!}";
    </script>

    <script src="{{ asset('Modules/Exam/Resources/assets/js/exam-types.js') }}"></script>
