...
@section('title', __('New User Access'))
        ...
        <div class="row mt-4">
            <div class="col-12">
                <div class="card">
                    @include('alert')
                    <div class="card-body">
                        <h4 class="header-title">{{ __('New User Access') }}</h4>
                        ...
                        <form action="{{ route('admin.accesses.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-12 text-center">
                                    <a href="{{ route('admin.accesses.index') }}" class="btn btn-outline-danger waves-effect waves-light"><i class="fe-delete"></i> {{ __('Cancel') }}</a>
